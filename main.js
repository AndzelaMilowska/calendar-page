    ...
    value: function setDateType() {
      ...
      dateTypeButtons.forEach(function (button) {
        return button.addEventListener('click', function () {
          ...
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("719573224_8_12_8_38_4", _this.dateType)));
        });
      });
    }
  }]);
